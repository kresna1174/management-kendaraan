    ...
    <div class="header-holder header-holder-desktop sticky-header" id="sticky-header-desktop">
        <div class="header-container container">
            <div class="header-wrap">
                <a href="{{ route('dashboard') }}"><img src="{{asset('assets/images/logo.png')}}"></a>
            </div>
            <div class="header-wrap header-wrap-block justify-content-start">
                <!-- BEGIN Nav -->
                    @if (auth()->user()->role == 'admin')
                            ...
                            <a href="{{ route('request-kendaraan') }}" data-href="{{ route('request-kendaraan') }}" class="nav-link"><i class="fas fa-building"></i> <span class="ml-3">Request Kendaraan</span></a>
                            <a href="{{ route('log-activity') }}" data-href="{{ route('log-activity') }}" class="nav-link"><i class="fas fa-building"></i> <span class="ml-3">Log User</span></a>
            ...
            <div class="header-wrap">
                ...
                <div class="dropdown ml-2">
                    <button class="btn btn-flat-primary widget13" data-toggle="dropdown">
                        <div class="widget13-text"> Hi <strong>{{ auth()->user()->username }}</strong>
                        </div>
                        <!-- BEGIN Avatar -->
                    ...
                    <div class="dropdown-menu dropdown-menu-wide dropdown-menu-right dropdown-menu-animated overflow-hidden py-0">
                        ...
                        <div class="portlet border-0">
                            ...
                            <div class="portlet-footer portlet-footer-bordered rounded-0">
                                <button type="button" class="btn btn-label-danger" onclick="document.location.href='{{ route('logout') }}'">Sign out</button>
                            </div>
                        </div>
                        <!-- END Portlet -->
                    </div>
    ...
    <div class="header-holder header-holder-mobile sticky-header" id="sticky-header-mobile">
        <div class="header-container container">
            ...
            <div class="header-wrap header-wrap-block">
                <h4 class="header-brand">Peduli Diri</h4>
            </div>
            <div class="header-wrap">
                <!-- BEGIN Dropdown -->
                <div class="dropdown ml-2">
